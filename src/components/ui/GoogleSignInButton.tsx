 ...
 * `/auth/google` endpoint. We use a plain anchor (not a fetch) because the
 * browser must follow the chain of redirects through Google's consent
 * screen and back to our callback — XHR can't do that.
 */
