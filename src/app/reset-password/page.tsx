    ...
    return (
      ...
      >
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row">
          <Link
            href={ROUTES.home}
            className="inline-flex flex-1 items-center justify-center rounded-full border border-gray-200 bg-white px-5 py-3 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-50"
          >
            Cancel
          </Link>
          <button
